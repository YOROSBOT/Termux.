			...
			switch(command) {
				...
				case 'sticker':
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`Envie uma imagem/vídeo/gif com a legenda ${prefix}sticker ou responda uma mensagem já enviada. Vídeos longos não serão convertidos , caso falhe envie dnv.`)
					}
					break
				case 'gtts':
